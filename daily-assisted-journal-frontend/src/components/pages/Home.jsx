...
const Home = () => {
  ...
  return (
    <div className='flex flex-col background-saturated h-screen w-screen'>
      {user && <Header />}
      <div className='flex-1 flex flex-col items-center justify-center text-color-main text-2xl  '
      >
